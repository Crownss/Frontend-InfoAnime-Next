                    ...
                    <div className="max-w-md mx-auto hover:shadow-xl overflow-hidden md:max-w-7xl rounded-3xl bg-black">
                        <div className="md:flex">
                            ...
                            <div className="p-8">
                                ...
                                Trailer: {result.trailer.youtube_id ?<iframe className="w-full" src={"https://youtube.com/embed/"+result.trailer.youtube_id+"?enablejsapi=1&wmode=opaque&autoplay=0"} height="400"></iframe>:"null"}</p>
                            </div>
                        </div>
                    </div>
